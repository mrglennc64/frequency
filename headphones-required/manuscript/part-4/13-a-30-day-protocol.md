...
*Part IV — The Practice · Target: 7 pp · Status: VOICE-CALIBRATED to Glenn (Jul 3, 2026) · journal = design-pass asset*
...
> **Intent:** ______ · **Session (name + certificate/audit result):** ______ · **Fixed time:** ______ · **Paired behavior:** ______
>
...
**Purpose:** Constructive payoff; honest structured practice + self-measurement; makes the book a practice guide, not just an exposé; V9 backbone. **Voice pass (Jul 3):** Glenn's coach voice; forensic. **Beats:** four design principles (one intent; baseline-first; session+paired behavior; fixed time); setup (intent configs → Forge presets; audit-your-track-first; demo sessions map 1:1); the 30 days (1–3 baseline / 4–24 practice / 25–27 removal / 28–30 resume+review, four questions); engineer's reading (win = modest & specific; three attributions; null result respected — "being allowed to find out is the product"); journal template (print + phone). **Bridge:** Ch. 14.
